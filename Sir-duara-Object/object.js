...
//     greet: function (){
//         let surname="Husain"
//         console.log("Hello"+" "+this.name+" "+surname+" "+this.rollno);
//     }
// }
...
//     prompts:function(){
//         let classes = "BCA";
//         console.log("Hello"+" "+this.Name+" "+this.lname+" "+this.roll_no+" "+classes);
//     }
// }
...
//    console.log(men3.name,men3.age)
...
//    console.log(valuess);  // ["John", 30, "New York"]
